...
namespace Izayoi.Collections
{
    ...
    public class ObservableTimestampedDictionary<TKey, TValue> :
        ...
        where TKey : struct
    {
        ...
        /// <summary></summary>
        private Subject<ObservableTimestampedDictionaryAddEvent<TKey, TValue>>? addSubject;

        /// <summary></summary>
        private Subject<ObservableTimestampedDictionaryRemoveEvent<TKey, TValue>>? removeSubject;

        /// <summary></summary>
        private Subject<ObservableTimestampedDictionaryUpdateEvent<TKey, TValue>>? updateSubject;
        ...
        /// <summary>
        /// Initializes an instance of the ObservableTimestampedDictionary class with the specified capacity, dictionary and comparer.
        /// </summary>
        ...
        public int ClearBefore(in long unixTimeMilliseconds)
        {
            lock (lockObject)
            {
                ...
                foreach (var timestampedKey in targetKeyList)
                {
                    ...
                    //removeSubject?.OnNext(new ObservableTimestampedDictionaryRemoveEvent<TKey, TValue>(removedData));
                }
            ...
            lock (lockObject)
            {
                if (dictionary.TryGetValue(key, out var oldData))
                {
                    if (dictionary.TryUpdate(key, newTimestampedDictionaryData, oldData))
                    {
                        ...
                        updateSubject?.OnNext(new ObservableTimestampedDictionaryUpdateEvent<TKey, TValue>(oldData, newTimestampedDictionaryData));
                    }
                    else
                    {
                ...
                else
                {
                    if (dictionary.TryAdd(key, newTimestampedDictionaryData))
                    {
                        ...
                        addSubject?.OnNext(new ObservableTimestampedDictionaryAddEvent<TKey, TValue>(newTimestampedDictionaryData));
        ...
        public bool TryAdd(in TKey key, in TValue? value)
        {
            ...
            lock (lockObject)
            {
                ...
                addSubject?.OnNext(new ObservableTimestampedDictionaryAddEvent<TKey, TValue>(timestampedDictionaryData));
        ...
        public bool TryUpdate(in TKey key, in TValue? newValue)
        {
            lock (lockObject)
            {
                ...
                updateSubject?.OnNext(new ObservableTimestampedDictionaryUpdateEvent<TKey, TValue>(oldTimestampedDictionaryData, newTimestampedDictionaryData));
            }
        ...
        public IObservable<ObservableTimestampedDictionaryAddEvent<TKey, TValue>> ObserveAdd()
        {
            if (isDisposed)
            {
                return Observable.Empty<ObservableTimestampedDictionaryAddEvent<TKey, TValue>>();
            }

            return addSubject ??= new Subject<ObservableTimestampedDictionaryAddEvent<TKey, TValue>>();
        }
        ...
        public IObservable<ObservableTimestampedDictionaryRemoveEvent<TKey, TValue>> ObserveRemove()
        {
            if (isDisposed)
            {
                return Observable.Empty<ObservableTimestampedDictionaryRemoveEvent<TKey, TValue>>();
            }

            return removeSubject ??= new Subject<ObservableTimestampedDictionaryRemoveEvent<TKey, TValue>>();
        }
        ...
        public IObservable<ObservableTimestampedDictionaryUpdateEvent<TKey, TValue>> ObserveUpdate()
        {
            if (isDisposed)
            {
                return Observable.Empty<ObservableTimestampedDictionaryUpdateEvent<TKey, TValue>>();
            }

            return updateSubject ??= new Subject<ObservableTimestampedDictionaryUpdateEvent<TKey, TValue>>();
        }
