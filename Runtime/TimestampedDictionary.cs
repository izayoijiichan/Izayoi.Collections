...
namespace Izayoi.Collections
{
    ...
    public class TimestampedDictionary<TValue> : ITimestampedDictionary<TValue>
    {
        #region Fields
        ...
        /// <summary>
        /// Initializes an instance of the TimestampedDictionary class with the specified capacity and dicionary.
        /// </summary>
        /// <param name="capacity">The maximum number of key/value pairs that can be contained in the dicionary. When -1, there is no limit.</param>
        /// <param name="dictionary">The IDictionary whose elements are copied to the new TimestampedDictionary.</param>
        /// <exception cref="ArgumentOutOfRangeException"></exception>
        /// <exception cref="ArgumentException"></exception>
        public TimestampedDictionary(in int capacity = -1, in IDictionary<string, TValue>? dictionary = null)
        {
            if (capacity == 0)
            {
        ...
        /// <param name="newValue">The value that replaces the value of the element that has the specified key. It can be null.</param>
