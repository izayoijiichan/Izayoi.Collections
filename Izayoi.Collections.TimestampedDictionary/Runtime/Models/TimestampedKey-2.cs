...
namespace Izayoi.Collections
{
    ...
    /// Timestamped Key
    /// </summary>
    public struct TimestampedKey<TKey> : IEquatable<TimestampedKey<TKey>> where TKey : struct
    {
        #region Fields
        ...
        private readonly TKey originalKey;
        ...
        public TimestampedKey(in TKey key)
        {
        ...
        public TimestampedKey(in TKey key, in long timestamp)
        {
        ...
        public readonly void Deconstruct(out long timestamp, out TKey key)
        {
        ...
        public readonly bool Equals(TimestampedKey<TKey> other)
        {
            return timestamp == other.timestamp &&
                   EqualityComparer<TKey>.Default.Equals(originalKey, other.originalKey);
        }

        public override readonly bool Equals(object? other)
        {
            if (other is TimestampedKey<TKey> otherTimestampedKey)
            {
        ...
        public static bool operator ==(in TimestampedKey<TKey> key1, in TimestampedKey<TKey> key2)
        {
