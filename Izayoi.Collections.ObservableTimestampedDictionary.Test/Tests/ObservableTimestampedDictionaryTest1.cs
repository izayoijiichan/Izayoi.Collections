...
namespace Izayoi.Collections.ObservableTimestampedDictionary.Test
{
    ...
    public class ObservableTimestampedDictionaryTest1
    {
        ...
        {
            var tsDictionary = new ObservableTimestampedDictionary<int>();
        ...
        {
            var tsDictionary = new ObservableTimestampedDictionary<int>(capacity);
        ...
        public async ValueTask Test1_Construct_with_initial_data(int testPatternIndex)
        {
            ...
            var tsDictionary = new ObservableTimestampedDictionary<int>(dictionary: initialData);
        ...
        public async ValueTask Test1_Construct_with_capacity_and_initial_data(int testPatternIndex)
        {
            ...
            var tsDictionary = new ObservableTimestampedDictionary<int>(capacity: initialData.Count, dictionary: initialData);
        ...
        public async ValueTask Test1_Construct_with_invalid_capacity_and_initial_data()
        {
            var exception = Assert.Throws<ArgumentOutOfRangeException>(() =>
            {
                ...
                var tsDictionary = new ObservableTimestampedDictionary<int>(capacity: initialData.Count - 1, initialData);
            });
        ...
        public async ValueTask Test1_TryAdd_and_TryGetValue_any(int testPatternIndex)
        {
            ...
            var tsDictionary = new ObservableTimestampedDictionary<int>(dictionary: inputData);
        ...
        {
            var tsDictionary = new ObservableTimestampedDictionary<int>(capacity: 1);
        ...
        {
            var tsDictionary = new ObservableTimestampedDictionary<int>(capacity: 2);
        ...
        public async ValueTask Test1_TryRemove_any(int testPatternIndex)
        {
            ...
            var tsDictionary = new ObservableTimestampedDictionary<int>(dictionary: inputDic);
        ...
        {
            var tsDictionary = new ObservableTimestampedDictionary<int>(initialCapacity);
